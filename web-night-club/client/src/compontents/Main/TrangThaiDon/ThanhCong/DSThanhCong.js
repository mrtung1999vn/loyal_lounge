...
function DSThanhCong({ ThanhCong , UpdateXoaThanhCong ,UpdateSuaThanhCong , onChangePage,totalPage,page, _onChangeImage}) {
  ...
  const onXoaThanhCong = (e)=>{
    UpdateXoaThanhCong(e)
  }
  const onSuaThanhCong = (e)=>{
    UpdateSuaThanhCong(e)
  }
                    ...
                    <TableBody>
                      ...
                      {ThanhCong.map((x,index) => (
                        <TableRow hover classes={{ hover: classes.hover }} key={x.id_don}>
                          ...
                          <TableCell align="left"><Link className="btn btn-warning btn-sm" to={`/ChiTietDonHang?stt=Thành công&id_don_hang=${x.id_don}&id_kh=${x.id_kh}`}
