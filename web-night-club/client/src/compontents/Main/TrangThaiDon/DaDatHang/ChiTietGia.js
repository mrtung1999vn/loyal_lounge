...
function ChiTietGia({dl}) {
    ...
    return (
        <Fragment>
            <button className="btn btn-primary btn-sm" data-toggle="modal" data-target={`#ChiTietGiaHoaDonDaDatHang${dl.id_don}`}>
                <i className="fas fa-eye">
                </i>
                Xem
            </button>
            {/* Modal */}
            <div className="modal fade" id={`ChiTietGiaHoaDonDaDatHang${dl.id_don}`} tabIndex={-1} role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
