...
function ListUsers( { ListDataUsers , onHandleEdit , onHandleDelete, LoaiDanhMuc}) {
            ...
            options: {
                ...
                customBodyRenderLite: (data, dataIndex, rowIndex) => {
                    ...
                    return (
                        ...
                        // <>sua</>
                        <EditUsers EditData={ListDataUsers[data]} onHandleEdit={onHandleEdit}></EditUsers>
            ...
            options: {
                ...
                customBodyRenderLite: (data, dataIndex, rowIndex) => {
                    ...
                    return (
                        // <Edit todo={dataSate[rowIndex]} OnSubmit={EditSubmit}></Edit>
                        // <>sua</>
                        <DeleteUsers EditData={ListDataUsers[data]} onHandleDelete={onHandleDelete}></DeleteUsers>
                        // <SuaDonHangSanPham DuLieuSua={DanhSachDonHangSanPham[data]} DuLieuSuaMoi={DuLieuSuaMoi}
                        //     onClickSua={_onClickSua} LoaiDanhMuc={LoaiDanhMuc}
                        // ></SuaDonHangSanPham>
                    );
