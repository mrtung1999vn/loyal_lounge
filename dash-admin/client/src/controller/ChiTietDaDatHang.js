...
function ChiTietDaDatHang({id_kh,stt,id_don_hang}) {
    ...
    const getData = React.useCallback(async ()=>{
      try {
          ...
          if(JsonData.status ===1){
            ...
            console.log( DE_JsonData[0].tien_ti_gia )
    ...
    const onClickDangPhatGiaoVan = async ()=>{
      try{
          const token = await Token.Token()
          var stt = "Đang phát giao vận"
          onClickCapNhap()
                ...
                <div className="invoice p-3 mb-3">
                  ...
                  <div className="row invoice-info">
                    <div className="col-sm-4 invoice-col">
                      ...
                      <address>
                        <strong>Tên khách : </strong><h1>{KhachHang.map(x => x.ten_kh)}</h1><br />
                      ...
                      <Table className="table table-striped" style={{width:'1000px !important'}}>
                        ...
                        <TableBody>
                          {GioHangKHCT.map((x,index)=>(
                            ...
                            <TableCell   style={{ width: '2rem !important' }}  >{
                            parseInt(x.price * x.qty * ti_gia_tinh).toLocaleString('vi', { style: 'currency', currency: 'VND' })
                            }</TableCell>
                        ...
                        <table className="table">
                          <tbody><tr>
                            ...
                            <tr>
                              ...
                              <td>{parseInt(TienGioHang* ti_gia_tinh).toLocaleString('vi', { style: 'currency', currency: 'VND' })}</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                              <th>Tiền phí nội địa ( {parseInt(phi_noi_dia)/ti_gia_tinh}¥)</th>
                            ...
                            <tr>
                              ...
                              parseInt(TienGioHang*ti_gia_tinh
                  ...
                  <div className="row no-print">
                    <div className="col-12">
                      ...
                      onClick={()=>onClickDangPhatGiaoVan()}
...
export default ChiTietDaDatHang
