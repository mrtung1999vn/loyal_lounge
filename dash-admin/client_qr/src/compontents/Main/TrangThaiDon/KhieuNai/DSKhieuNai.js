...
function DSKhieuNai({ KhieuNai , UpdateXoaKhieuNai ,UpdateSuaKhieuNai , onChangePage,totalPage,page,_onChangeImage}) {
  ...
  const onXoaKhieuNai = (e)=>{
    UpdateXoaKhieuNai(e)
  }
  const onSuaKhieuNai = (e)=>{
    UpdateSuaKhieuNai(e)
  }
                    ...
                    <TableBody>
                      ...
                      {KhieuNai.map((x,index) => (
                        <TableRow hover classes={{ hover: classes.hover }} key={x.id_don}>
                          ...
                          <TableCell>{x.ghi_chu}</TableCell>
                          {/* <TableCell align="left">
                                <ChiTietGia dl={x}></ChiTietGia>
                          </TableCell> */}
                          
                          <TableCell align="left"><Link className="btn btn-warning btn-sm" to={`/ChiTietDonHang?stt=Khiếu nại&id_don_hang=${x.id_don}&id_kh=${x.id_kh}`}
