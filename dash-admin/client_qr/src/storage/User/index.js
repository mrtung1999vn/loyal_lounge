...
const setUserData = (data)=>{
    window.localStorage.setItem('_____dir', data)
}

const getUserData = ()=>{
    return func.DecodeJson_RESPONSE( window.localStorage.getItem('_____dir') )
}

export default {

    setUser,getUser,setUserLogin,getUserLogin,clearUser,setUserData,
    getUserData
