...
function SuaSanPham({ DuLieuSua, onClickSua, LoaiDanhMuc }) {
    // useState
    ...
    React.useEffect(async () => {
        try {
            setten_hang(DuLieuSua.ten_hang); setimage_02(DuLieuSua.image_02);
    ...
    return (
        <React.Fragment>
            ...
            <div>
                ...
                <button type="button" className="btn btn-primary" data-toggle="modal" data-target={`#id_hang${DuLieuSua.id_hang}`}>
                    Sửa
                </button>
                {/* Modal */}
                <div className="modal fade bd-example-modal-lg" id={`id_hang${DuLieuSua.id_hang}`} tabIndex={-1} role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
