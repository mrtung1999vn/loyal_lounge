...
import ListWithdrawMoney from './WithdrawMoney/ListWithdrawMoney'
import $ from 'jquery'
...
function WithdrawMoney() {
    ...
    const onClickWithdrawMoney = async ()=>{
        try {
            $('#WithdrawMoney').prop('disabled', true);
            if( User[0]?.email !== Email ){
                ...
                alert('User entered wrong money (Filling example  1000 or 10.05 )')
            }else{
                if( parseFloat(Money) > parseFloat(coin) ){
                    alert('Withdrawal amount is larger than current amount!')
                }else{
            ...
            $('#WithdrawMoney').prop('disabled', false);
        } catch (error) {
            $('#WithdrawMoney').prop('disabled', false);
        }   
    }
                            ...
                            <div className="breadcrumb-content">
                                ...
                                <ul>
                                    ...
                                    <Link to="/WithdrawMoney">
                                        <a style={{color:'white'}} >WithDraw money</a>
                                    </Link >
                                </ul>
                            </div>
                        </div>
                    ...
                    <div className="row justify-content-center">
                        <div className="col-xl-5 col-lg-5 col-md-6">
                            <div className="login-form">
                                <label><label style={{fontWeight:'bold'}}>Note: </label> Users need to fill in information to withdraw money</label>
                                ...
                                <br></br>
                                <label>Withdrawal amount must be less than or equal to {formatter.format(parseFloat(coin))}</label>
                                <label>WithDraw money  ({formatter.format(parseFloat(Money))})</label>
                               ...
                               <label>Your Email</label>
                                ...
                                <button 
                                id="WithdrawMoney"
                                onClick={() => onClickWithdrawMoney()}>Login</button>
                            </div>
                        </div>
