...
module.exports = function (app) {
    ...
    app.get(`/WebDash/DanhSachTable`, async (req, res) => {
        try {
            ...
            SaveError('web-dash-admin', '/WebDash/DanhSachTable', error, 'GET', JSON.stringify(req.headers), req.socket.remoteAddress)
            res.json({
                status: 0,
                data: [],
                msg_vn: 'Lỗi hệ thống',
    ...
    app.post(`/WebDash/DanhSachTable`, async (req, res) => {
        try {
            ...
            SaveError('web-dash-admin', '/WebDash/DanhSachTable', error, 'POST', JSON.stringify(req.headers), req.socket.remoteAddress)
            res.json({
                status: 0,
                data: [],
                msg_vn: 'Lỗi hệ thống',
    ...
    app.put(`/WebDash/DanhSachTable`, async (req, res) => {
        try {
            ...
            SaveError('web-dash-admin', '/WebDash/DanhSachTable', error, 'PUT', JSON.stringify(req.headers), req.socket.remoteAddress)
            res.json({
                status: 0,
                data: [],
                msg_vn: 'Lỗi hệ thống',
    ...
    app.delete(`/WebDash/DanhSachTable`, async (req, res) => {
        try {
            const { id_tk_admin,ten_tai_khoan, mat_khau } = req.body
            if (
                !checkRequest(req.headers.origin) ||
            ...
            SaveError('web-dash-admin', '/WebDash/DanhSachTable', error, 'DELETE', JSON.stringify(req.headers), req.socket.remoteAddress)
            res.json({
                status: 0,
                data: [],
                msg_vn: 'Lỗi hệ thống',
